...
const Contact = () => {
  ...
  return (
    <div className="bg-gray-60 min-h-screen flex justify-center items-center">
      <div className="flex flex-col md:flex-row items-center w-full md:w-4/5 lg:w-3/4">
        {/* Left Card */}
        <div className="bg-white p-4 rounded-lg shadow-md w-full md:w-1/3 lg:w-1/4 mb-4 md:mb-0">
          {/* Your content for the left card, such as an image */}
          <img src={images.contact} alt="Your Image" className="w-full" />
        </div>

        {/* Right Card */}
        <div className="bg-white p-6 rounded-lg shadow-md w-full md:w-2/3 lg:w-3/4 md:ml-4">
          {/* Two Cards Above the Form */}
          ...
          <div className="w-full p-4 shadow-md lg:max-w-lg">
            <div className="space-y-2">
                ...
                <p className='flex justify-center'><a href=" mailto:felixkent360@gmail.com " className="underline-offset-auto">felixkent360@gmail.com </a></p>
                <p className="text-black-600 flex justify-center">
                   Email me
                </p>
            </div>
        </div>
          ...
          <div className="bg-white p-4 rounded-lg shadow-md space-y-2">
            <h3 className='text-3xl font-semibold flex justify-center'><AiFillCalendar />
            </h3>
